...
public class FragmentQueroLer extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_quero_ler, container, false);
        ...
        livros = myBooksDB.daoLivro().selecionarTodosLivrosQuero();
